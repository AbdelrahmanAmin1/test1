<html lang="en"><head>
    ...
    <link rel="icon" href="./image/rerererererere.png" type="image/icon type">
    <!-- SWIPER -->
...
<body>
    ...
    <section class="about" id="about">
       ...
       <!--specify Location to filter products-->
       <?php
       // Start the session
       session_start();
       
       // Retrieve the user's location from the session
       $user_location = isset($_SESSION['user_location']) ? $_SESSION['user_location'] : '';
       
       // Define a function to filter products based on location
       function filterProductsByLocation($products, $location) {
       ...
       // Filter products based on the user's location
       $filtered_products = filterProductsByLocation($productData, $user_location);
       ?>
           ...
           <section class="menu" id="menu">
               ...
               $product_array = $db_handle->runQuery("SELECT * FROM table Products ORDER BY id ASC");
               ?>
               <h1 class="heading">our menu <span>popular menu</span></h1>
       
               <div class="box-container">
                   <?php foreach($product_array as $product) {?>
                   <form method="post" action="HandelingCart.php?action=add&code=<?php echo $product_array[0]["code"]; ?>">
                   <a href="#" class="box">
                       <img src="image/menu-1.png" alt="">
                       <div class="content">
                           <h3><?php echo $product["Caffeinated Canvas Signature Latte"]; ?></h3>
                           ...
                           <span>$<?php echo $product["$10.99"]; ?></span>
                           <button id="add-to-cart-button" class="add-to-cart" data-price="<?php echo $product['10.99']; ?>" data-name="<?php echo $product['Caffeinated Canvas Signature Latte']; ?>">Add to Cart</button>
                   ...
                   <form method="post" action="HandelingCart.php?action=add&code=<?php echo $product_array[1]["code"]; ?>">
                   <a href="#" class="box">
                       <img src="image/menu-2.png" alt="">
                       <div class="content">
                           <h3><?php echo $product["Decadent Mocha"]; ?></h3>
                           ...
                           <span>$<?php echo $product["$12.99"]; ?></span>
                           <button id="add-to-cart-button" class="add-to-cart" data-price="<?php echo $product['$12.99']; ?>" data-name="<?php echo $product['Decadent Mocha']; ?>">Add to Cart</button>
                   ...
                   <form method="post" action="HandelingCart.php?action=add&code=<?php echo $product_array[2]["code"]; ?>">
                   <a href="#" class="box">
                       <img src="image/menu-3.png" alt="">
                       <div class="content">
                           <h3><?php echo $product["Classic Cappuccino"]; ?> </h3>
                           ...
                           <span>$9.99</span>
                           <button id="add-to-cart-button" class="add-to-cart" data-price="$9.99" data-name="Classic Cappuccino">Add to Cart</button>
                 ...
                 <form method="post" action="HandelingCart.php?action=add&code=<?php echo $product_array[3]["code"]; ?>">
                   <a href="#" class="box">
                       <img src="image/menu-4.png" alt="">
                       <div class="content">
                           <h3><?php echo $product["Hot Chocolate"]; ?></h3>
                           ...
                           <span>$14.99</span>
                           <button id="add-to-cart-button" class="add-to-cart" data-price="$14.99" data-name="Hot Choccolate">Add to Cart</button>
                 ...
                 <form method="post" action="HandelingCart.php?action=add&code=<?php echo $product_array[4]["code"]; ?>">
                   <a href="#" class="box">
                       <img src="image/menu-5.png" alt="">
                       <div class="content">
                           <h3><?php echo $product["Artisan Flat White"]; ?></h3>
                           ...
                           <span>$12.99</span>
                           <button id="add-to-cart-button" class="add-to-cart" data-price="$12.99" data-name="Artisan Flat White">Add to Cart</button>
                ...
                <form method="post" action="HandelingCart.php?action=add&code=<?php echo $product_array[5]["code"]; ?>">
                   <a href="#" class="box">
                       <img src="image/menu-6.png" alt="">
                       <div class="content">
                           <h3><?php echo $product["Velvet Macchiato "]; ?> </h3>
                           ...
                           <span>$10.99</span>
                           <button id="add-to-cart-button" class="add-to-cart" data-price="$10.99" data-name="Velvet Macchiato">Add to Cart</button>
           ...
           <section class="menu" id="pastry">
               ...
               <form method="post" action="HandelingCart.php?action=add&code=<?php echo $product_array[6]["code"]; ?>">
                   <a href="#" class="box">
                       <img src="./image/Bakery-Transparent.png" alt="A delightful Cookies">
                       <div class="content">
                           <h3><?php echo $product["Canvas Cookies"]; ?></h3>
                           ...
                           <span>$4.99</span>
                           <button id="add-to-cart-button" class="add-to-cart" data-price="$4.99" data-name="Canvas Cookies">Add to Cart</button>
                   ...
                   <form method="post" action="HandelingCart.php?action=add&code=<?php echo $product_array[7]["code"]; ?>">
                   <a href="#" class="box">
                       <img src="./image/Cup.png" alt="a delicious cupcake">
                       <div class="content">
                           <h3><?php echo $product["Canvas Cupcakes"]; ?></h3>
                           ...
                           <span>$7.99</span>
                           <button id="add-to-cart-button" class="add-to-cart" data-price="$7.99" data-name="Canvas Cupcakes">Add to Cart</button>
                   ...
                   <form method="post" action="HandelingCart.php?action=add&code=<?php echo $product_array[8]["code"]; ?>">
                   <a href="#" class="box">
                       <img src="./image/tarte.png" alt="a delicious tart">
                       <div class="content">
                           <h3><?php echo $product["Canvas Tarte"]; ?></h3>
                           ...
                           <span>$10.99</span>
                           <button id="add-to-cart-button" class="add-to-cart" data-price="$10.99" data-name="Canvas Tarte">Add to Cart</button>
                   ...
                   <form method="post" action="HandelingCart.php?action=add&code=<?php echo $product_array[9]["code"]; ?>">
                   <a href="#" class="box">
                       <img src="./image/Cheesecake.png" alt="Cheesecake">
                       <div class="content">
                           <h3><?php echo $product["Canvas Cheesecake"]; ?></h3>
                           ...
                           <span>$12.99</span>
                           <button id="add-to-cart-button" class="add-to-cart" data-price="$12.99" data-name="Canvas Cheesecake">Add to Cart</button>
                   ...
                   <form method="post" action="HandelingCart.php?action=add&code=<?php echo $product_array[10]["code"]; ?>">
                   <a href="#" class="box">
                       <img src="./image/Crepe.png" alt="Crepe">
                       <div class="content">
                           <h3><?php echo $product["Canvas Crepe"]; ?></h3>
                           ...
                           <span>$19.99</span>
                           <button id="add-to-cart-button" class="add-to-cart" data-price="$19.99" data-name="Canvas Crepe">Add to Cart</button>
                   ...
                   <form method="post" action="HandelingCart.php?action=add&code=<?php echo $product_array[11]["code"]; ?>">
                   <a href="#" class="box">
                       <img src="./image/Croissant-Transparent.png" alt="Croissant">
                       <div class="content">
                           <h3><?php echo $product["Canvas Croissant"]; ?></h3>
                           ...
                           <span>$10.99</span>
                           <button id="add-to-cart-button" class="add-to-cart" data-price="$10.99" data-name="Canvas Croissant" style=" justify-content: 100px;">Add to Cart</button>
   ...
   <section class="review" id="review">
        ...
        <div class="swiper review-slider swiper-initialized swiper-horizontal swiper-pointer-events">
            ...
            <div class="swiper-slide box " data-swiper-slide-index="2" role="group" aria-label="3 / 4" style="width: 431.5px; margin-right: 20px;">
                    ...
                    <p>"As a coffee aficionado, I've tried countless blends, but Caffeinated Canvas truly stands out.
                         Their attention to detail in roasting brings out nuanced flavors that dance on the palate. Whether
                          I'm in need of a morning pick-me-up or a midday boost,
                         Caffeinated Canvas never fails to impress. It's become my go-to spot for the perfect cup of joe.".</p>
                    <h3>Jamie Dornan</h3>
                ...
                <div class="swiper-slide box " data-swiper-slide-index="3" role="group" aria-label="4 / 4" style="width: 431.5px; margin-right: 20px;">
                    ...
                    <p> "Caffeinated Canvas has redefined my coffee experience. From the first sip, I knew I had stumbled
                         upon something special. Their dedication to sourcing high-quality beans is evident in the rich, 
                         robust flavors of their coffee. What sets them apart is not just their exceptional brews but also the warm,
                         welcoming atmosphere they cultivate.
                         Whether I'm catching up with friends or diving into a good book, Caffeinated Canvas feels like home.".</p>
                    <h3>Millie Boobby Brown</h3>
                    <span>satisfied client</span>
                </div>
                <div class="swiper-slide box" data-swiper-slide-index="0" role="group" aria-label="1 / 4" style="width: 431.5px; margin-right: 20px;">
                    ...
                    <p>"I'm not usually one to leave reviews, but Caffeinated Canvas has left such a lasting impression on me that
                         I couldn't resist. Their espresso is a work of art, bold yet balanced, with a depth of flavor that keeps 
                         me coming back for more. It's evident that they take pride in their craft, and it shines through in every cup.
                         Whether you're a coffee connoisseur or just looking for a great brew, Caffeinated Canvas is a must-visit."</p>
                    <h3>Ryan Gosling</h3>
                    <span>satisfied client</span>
                </div>
                ...
                <div class="swiper-slide box swiper-slide-prev" data-swiper-slide-index="1" role="group" aria-label="2 / 4" style="width: 431.5px; margin-right: 20px;">
                    ...
                    <p>"Caffeinated Canvas is my sanctuary in the bustling city. Their coffee not only fuels my day but also warms my soul.
                         The rich, velvety texture of their lattes is unparalleled, and each sip feels like a comforting embrace. The ambiance is serene, 
                         making it the ideal spot to unwind and indulge in a moment of tranquility.
                         Caffeinated Canvas has become my haven away from the chaos of everyday life."</p>
    ...
    <section class="footer">
        <div class="box-container">
            ...
            <div class="box">
                <h3>contact info</h3>
                <a href="#"><i class="fas fa-phone"></i> +1 817-846-8380</a>
                <a href="#"><i class="fas fa-phone"></i> +1 540-666-2003</a>
