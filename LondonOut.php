<html lang="en"><head>
    ...
    <link rel="icon" href="./image/imageLondon/bigben.png" type="image/icon type">
    <!-- SWIPER -->
...
<body>
    ...
    <header class="header">
        ...
        <a href="./London.html" class="btn">Sign Out</a>
    </header>
    ...
    <section class="home" id="home">
        <div class="row">
            ...
            <div class="image">
                <img src="image/home-img-1.png" class="main-home-image" alt="Coffee Cup">
            </div>
        </div>

        <div class="image-slider">
            <img src="image/home-img-1.png" alt="Coffee Cup">
            <img src="image/home-image-2.png" alt="Coffee Cup">
            <img src="image/home-img-3.png" alt="Coffee Cup">
        </div>
    </section>
        ...
        <div class="box-container">
            <a href="#" class="box">
                ...
                <div class="content">
                    ...
                    <span>€10.99</span>
                    <button id="add-to-cart-button" class="add-to-cart" data-price="€10.99" data-name="Caffeinated Canvas Signature Latte">Add to Cart</button>
            ...
            <a href="#" class="box">
                ...
                <div class="content">
                    ...
                    <span> €12.99</span>
                    <button id="add-to-cart-button" class="add-to-cart" data-price="€12.99" data-name="Decadent Mocha">Add to Cart</button>
        ...
        <div class="box-container">
            <a href="#" class="box">
                ...
                <div class="content">
                    ...
                    <button id="view-nutritional-info-button" class="view-nutritional-info " class="view-nutritional-info" data-target="nutritional-info-popup-7">View Nutritional Info</button>
                </div>
            </a>
            ...
            <a href="#" class="box">
                ...
                <div class="content">
                    ...
                    <button id="view-nutritional-info-button" class="view-nutritional-info "  class="view-nutritional-info" data-target="nutritional-info-popup-8">View Nutritional Info</button>
                </div>
            </a>
            ...
            <a href="#" class="box">
                ...
                <div class="content">
                    ...
                    <button id="view-nutritional-info-button" class="view-nutritional-info"  class="view-nutritional-info" data-target="nutritional-info-popup-9">View Nutritional Info</button>
            ...
            <a href="#" class="box">
                ...
                <div class="content">
                    ...
                    <button id="view-nutritional-info-button" class="view-nutritional-info add-to-cart"  class="view-nutritional-info" data-target="nutritional-info-popup-10">View Nutritional Info</button>
                </div>
            </a>
            ...
            <a href="#" class="box">
                ...
                <div class="content">
                    ...
                    <button id="view-nutritional-info-button" class="view-nutritional-info add-to-cart"  class="view-nutritional-info" data-target="nutritional-info-popup-11">View Nutritional Info</button>
            ...
            <a href="#" class="box">
                ...
                <div class="content">
                    ...
                    <button id="view-nutritional-info-button" class="view-nutritional-info add-to-cart"  class="view-nutritional-info" data-target="nutritional-info-popup-12">View Nutritional Info</button>
                </div>
            </a>
        </div>
    </section>
   ...
   <section class="review" id="review">
        ...
        <div class="swiper review-slider swiper-initialized swiper-horizontal swiper-pointer-events">
            ...
            <div class="swiper-slide box " data-swiper-slide-index="2" role="group" aria-label="3 / 4" style="width: 431.5px; margin-right: 20px;">
                    ...
                    <img src="./image/imageLondon/Geroge.jpg" alt="George Coloney Photo">
                    <div class="stars">
                    ...
                    <p>"Ah, Caffeine Canvas, where every cup tells a tale of indulgence and refinement. As you step through its doors, you're greeted by the tantalizing scent of freshly roasted coffee,
                         beckoning you into a world of sensory delight.
                        Within its walls, elegance mingles effortlessly with comfort,
                         creating an ambiance that soothes the soul and stimulates the mind. It's a place where conversations flow as smoothly as the espresso, and laughter dances in the air like the froth on a cappuccino.
                        And the coffee? It's a work of art, meticulously crafted to perfection. Each sip is a journey, a moment of pure bliss that transports you to a realm of pure indulgence.</p>
                    <h3>George Coloney</h3>
                ...
                <div class="swiper-slide box " data-swiper-slide-index="3" role="group" aria-label="4 / 4" style="width: 431.5px; margin-right: 20px;">
                    <i class="fas fa-quote-left"></i>
                    <i class="fas fa-quote-right"></i>
                    <img src="image/imageLondon/taylor.jpg" alt="Taylor Swift Photo">
                    <div class="stars">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                    ...
                    <p> "Stepping into Caffeine Canvas is like stepping into a melody, where each aroma dances in harmony with the next. It's a symphony of scents that fills the air,
                         promising a journey of both comfort and adventure.
                        In every corner, there's a story waiting to be told, a moment waiting to be captured. It's a place where time slows down, and you find yourself lost in the magic of the moment.
                        The coffee? Oh, it's like a love story in a cup. From the first sip to the last, it wraps you in warmth and whispers secrets only you can hear.</p>
                    <h3>Taylor Swift</h3>
                    <span>satisfied client</span>
                </div>
                <div class="swiper-slide box" data-swiper-slide-index="0" role="group" aria-label="1 / 4" style="width: 431.5px; margin-right: 20px;">
                    <i class="fas fa-quote-left"></i>
                    <i class="fas fa-quote-right"></i>
                    <img src="image/imageLondon/Justin.jpg" alt="Justin Timberlake Photo">
                    <div class="stars">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                    ...
                    <p>"Caffeine Canvas is where it's at! Picture this: you step in, and boom! You're hit with this crazy aroma of freshly brewed magic. It's like a party for your senses, man!
                        The vibes? Off the charts! You've got this chill yet electric energy buzzing in the air. It's like every corner has its own story, and you're just waiting to dive in.
                        And the coffee? Let me tell you, it's next-level. From the smoothest lattes to the boldest espressos, every sip is like a hit song you can't get enough of."</p>
                ...
                <div class="swiper-slide box swiper-slide-prev" data-swiper-slide-index="1" role="group" aria-label="2 / 4" style="width: 431.5px; margin-right: 20px;">
                    <i class="fas fa-quote-left"></i>
                    <i class="fas fa-quote-right"></i>
                    <img src="image/imageLondon/Catherine Deneuve.jpg" alt="Catherine Deneuve Photo">
                    <div class="stars">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                    ...
                    <p>"At Caffeine Canvas, one finds oneself immersed in a symphony of sensations, where each sip of coffee is a journey unto itself.
                         The ambiance exudes an understated elegance, inviting patrons to linger and savor the moment.
                        As the aroma of freshly brewed coffee wafts through the air, one is transported to a realm of indulgence and refinement.
                         The café becomes a sanctuary for contemplation and connection, where conversations flow as freely as the espresso."</p>
    ...
    <section class="footer">
        <div class="box-container">
            ...
            <div class="box">
                <h3>contact info</h3>
                <a href="#"><i class="fas fa-phone"></i> +447494859645</a>
                <a href="#"><i class="fas fa-phone"></i> +447852494724</a>
